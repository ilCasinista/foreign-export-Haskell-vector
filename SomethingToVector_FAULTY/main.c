...
{   if (argc < 2) {printf("Usage: %s <intNumber>\n", argv[0]);return 2;}
    ...
    C_DoubleVector* doubleVecPtr_OUTPUT = somethingToVec_hs(arg_int);
    printf("output Vec: "); doubleVecPtr_show(*doubleVecPtr_OUTPUT);            printf("\n");
    ...
    vector_free_hs(doubleVecPtr_OUTPUT);
