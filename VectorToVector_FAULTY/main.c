...
#include "VectorToVector_FAULTY/Lib_stub.h"
...
{   if (argc < 2) {printf("Usage: %s <intNumber>\n", argv[0]);return 2;}
    ...
    C_DoubleVector* doubleVecPtr_OUTPUT_2 = twiceVec_hs(doubleVecPtr_INPUT);
    printf("twice:      "); doubleVecPtr_show(*doubleVecPtr_OUTPUT_2); printf("\n");

    C_DoubleVector* doubleVecPtr_OUTPUT_4 = twiceVec_hs(doubleVecPtr_OUTPUT_2);
    printf("four times: "); doubleVecPtr_show(*doubleVecPtr_OUTPUT_4); printf("\n");

    vector_free_hs(doubleVecPtr_OUTPUT_4);
    vector_free_hs(doubleVecPtr_OUTPUT_2);
